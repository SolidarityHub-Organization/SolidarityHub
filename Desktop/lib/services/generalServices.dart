...
class GeneralService {
  ...
  Future<List<Map<String, dynamic>>> fetchRecentActivity(DateTime startDate, DateTime endDate) async {
    final String params = 'fromDate=${startDate.toIso8601String()}&toDate=${endDate.toIso8601String()}';

    final response = await http.get(Uri.parse('$baseUrl/api/v1/dashboard/activity-log?$params'));
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error al obtener el registro de actividad: ${response.statusCode}');
    }
  }
}
