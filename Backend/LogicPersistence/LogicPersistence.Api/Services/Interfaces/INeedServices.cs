...
namespace LogicPersistence.Api.Services
{
	public interface INeedServices {
		...
		Task<(IEnumerable<Need> Needs, int TotalCount)> GetPaginatedNeedsAsync(int pageNumber, int pageSize);
		#endregion
		...
		Task<(IEnumerable<NeedType> NeedTypes, int TotalCount)> GetPaginatedNeedTypesAsync(int pageNumber, int pageSize);
		#endregion
	}
