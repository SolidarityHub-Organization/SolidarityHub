...
public class GeneralRepository : IGeneralRepository {
	...
	public async Task<bool> SuperPopulateDatabaseAsync() {
		try {
			using var connection = new NpgsqlConnection(connectionString);
			await connection.OpenAsync();
			...
			string scriptPath = Path.Combine(projectDirectory, "Migrations", "SQL", "SuperPopulateTables.sql");
			...
			Console.WriteLine($"Error super populating database: {ex.Message}");
			return false;
		}
	}
	#endregion
